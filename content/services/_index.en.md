...
### Sound Services (delivered and setup)

| Service | Price |
|---------|-------|
| PA + mics + setup/teardown | $200 |
| Sound engineer | $40/hr |
...
|---------|----------|-------|
| 🎸 Full Event | 1-set band (1 hr) + PA + sound engineer + music between sets (4 hrs total) | ~~$710~~ **$600** |
| 🎧 Sound Only | PA + sound engineer + music playback (4 hrs) | ~~$410~~ **$300** |
